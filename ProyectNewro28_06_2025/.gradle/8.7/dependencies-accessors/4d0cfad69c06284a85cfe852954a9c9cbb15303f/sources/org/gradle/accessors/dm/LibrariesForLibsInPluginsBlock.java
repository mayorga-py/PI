...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class ComLibraryAccessors extends SubDependencyFactory {
        private final ComJourneyappsLibraryAccessors laccForComJourneyappsLibraryAccessors = new ComJourneyappsLibraryAccessors(owner);

        public ComLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>com.journeyapps</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public ComJourneyappsLibraryAccessors getJourneyapps() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForComJourneyappsLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class ComJourneyappsLibraryAccessors extends SubDependencyFactory {
        private final ComJourneyappsZxingLibraryAccessors laccForComJourneyappsZxingLibraryAccessors = new ComJourneyappsZxingLibraryAccessors(owner);

        public ComJourneyappsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>com.journeyapps.zxing</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public ComJourneyappsZxingLibraryAccessors getZxing() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForComJourneyappsZxingLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class ComJourneyappsZxingLibraryAccessors extends SubDependencyFactory {
        private final ComJourneyappsZxingAndroidLibraryAccessors laccForComJourneyappsZxingAndroidLibraryAccessors = new ComJourneyappsZxingAndroidLibraryAccessors(owner);

        public ComJourneyappsZxingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>com.journeyapps.zxing.android</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public ComJourneyappsZxingAndroidLibraryAccessors getAndroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForComJourneyappsZxingAndroidLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class ComJourneyappsZxingAndroidLibraryAccessors extends SubDependencyFactory {

        public ComJourneyappsZxingAndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>embedded</b> with <b>com.journeyapps:zxing-android-embedded</b> coordinates and
         * with version reference <b>journeyappsZxingAndroidEmbedded</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getEmbedded() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("com.journeyapps.zxing.android.embedded");
        }
    ...
    public static class CommonsLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>commonsCollections4</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>commonsCollections4</b> with value <b>4.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCommonsCollections4() { return getVersion("commonsCollections4"); }
        ...
        /**
         * Version alias <b>journeyappsZxingAndroidEmbedded</b> with value <b>4.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJourneyappsZxingAndroidEmbedded() { return getVersion("journeyappsZxingAndroidEmbedded"); }
        ...
        /**
         * Version alias <b>poi</b> with value <b>5.2.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
